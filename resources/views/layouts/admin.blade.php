...
<head>
  ...
  <title>Admin Dashboard - PostsStar</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin') }}" class="nav-link {{ ($activeElement == 'dash') ? 'active' : ''}}">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.ban') }}" class="nav-link {{ ($activeElement == 'ban') ? 'active' : ''}}">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{ ($mainTitle) ? $mainTitle : '' }}</h1>
          </div><!-- /.col -->
